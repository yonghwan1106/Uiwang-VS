...
export default function ArchiveList() {
  ...
  if (ideas.length === 0) {
    return (
      <div className="rounded-xl bg-white p-12 shadow-lg text-center">
        ...
        <a
          href="/"
          className="mt-6 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl active:scale-95"
        >
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {ideas.map((idea) => (
          <div
            ...
            className="cursor-pointer rounded-xl bg-white p-6 shadow-lg border border-gray-200 transition-all hover:shadow-xl hover:border-blue-300 hover:scale-[1.02]"
          >
        ...
        >
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="rounded-lg bg-gradient-to-br from-green-50 to-emerald-50 p-6 border border-green-200">
                <ReactMarkdown
                  components={{
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="rounded-lg bg-purple-50 p-4">
                ...
                <p className="text-gray-900">{selectedIdea.date}</p>
              </div>
            </div>
